...
st.markdown("""
This dashboard visualizes the **optimized ICU bed allocation** based on actual COVID demand and hospital capacity. 
You can also simulate your own demand scenarios based on severity levels.
""")
...
tabs = st.tabs(["📊 Allocation Overview", "🧪 Simulate ICU Demand"])
...
with tabs[1]:
    ...
    if simulate_button:
        # Normalize severity distribution to ensure sum = 100%
        total_perc = perc_moderate + perc_severe + perc_critical
        perc_moderate = 100 * perc_moderate / total_perc
        perc_severe = 100 * perc_severe / total_perc
        perc_critical = 100 * perc_critical / total_perc
